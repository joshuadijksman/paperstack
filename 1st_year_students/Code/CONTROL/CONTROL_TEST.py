...
with open(f'E:/Documents/GitHub/2025-Projects_Team-1-Bouncing-on-Paper-The-Surprising-Restitution-Coefficient-of-a-Paper-Stack-/Code/CONTROL/CONTROL-1-2-M.csv', 'r') as yurr:
    ...
    plt.xlim(0, 400)
    plt.ylim(-20, 20)
    plt.savefig('CONTROL_TEST_POS_AND_SPEED.png', bbox_inches='tight')
...
# plt.ylabel('Starting height (px)')
# plt.legend()
# plt.savefig('CONTROL_TEST_MEDIUM_BLUE_MARBLE_COR.png')
...
# plt.ylabel('Starting height (px)')
# plt.legend()
# plt.savefig('CONTROL_TEST_SMALL_METAL_MARBLE_COR.png')
# plt.show()
